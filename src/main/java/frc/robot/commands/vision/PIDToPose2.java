...
public class PIDToPose2 extends Command {
  ...
  private final ProfiledPIDController xController =
      new ProfiledPIDController(
          SwerveConstants.driveKP * 4,
          SwerveConstants.driveKI,
          SwerveConstants.driveKD * 2,
          new TrapezoidProfile.Constraints(SwerveConstants.dMaxVelocity * 2.8, SwerveConstants.dMaxAccel),
          0.02);
  ...
  public PIDToPose2(CommandSwerveDrivetrain drivetrain, Pose2d goalPose, int id) {
  ...
  public void initialize() {
    ...
    Pose2d goalTagPose2d = goalPose.relativeTo(CommandSwerveDrivetrain.tagPoseAndymarkMap.get(id));
  ...
  public void execute() {
    ...
    Translation2d fieldVelocity = new Translation2d(xController.calculate(currentTagPose2d.getX()), yController.calculate(currentTagPose2d.getY())).rotateBy(targetPose.getRotation());
