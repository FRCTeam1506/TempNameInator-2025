...
public class driveToTagHolonomic extends Command {
  ...
  public void initialize() {
    if(!LimelightHelpers.getTV(Constants.VisionConstants.LL_CENTER)){
      isFinished = true;
    }
  }
  ...
  @Override
  public void execute() {
    Pose2d goal = LimelightHelpers.getCameraPose3d_TargetSpace(VisionConstants.LL_CENTER).toPose2d();
