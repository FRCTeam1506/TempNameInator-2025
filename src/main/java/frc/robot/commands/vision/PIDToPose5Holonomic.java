 ...
 */
public class PIDToPose5Holonomic extends Command {
   ...
   */
  public PIDToPose5Holonomic(CommandSwerveDrivetrain drivetrain, Pose2d goalPose) {
  ...
  public static Command figureAprilTagPose(CommandSwerveDrivetrain drivetrain){

    int id = (int) drivetrain.getTag();
    Pose2d target = CommandSwerveDrivetrain.tagPoseAndymarkMap.get(id);

    return new PIDToPose5Holonomic(drivetrain, target);
  }
}