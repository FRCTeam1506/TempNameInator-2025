 ...
 */
public class JalignRight extends Command {
  ...
  private final ProfiledPIDController xController =
      new ProfiledPIDController(
          ...
          new TrapezoidProfile.Constraints(SwerveConstants.dMaxVelocity * 2, SwerveConstants.dMaxAccel),
          0.02);
   ...
   */
  public JalignRight(CommandSwerveDrivetrain drivetrain) {
  ...
  public void initialize() {
    ...
    this.targetPose = new Pose2d(-0.3, 0.06, new Rotation2d(0)); //y used to = 0.1
  ...
  public boolean isFinished() {
    return this.timer.hasElapsed(timeout) || !LimelightHelpers.getTV(VisionConstants.LL_CENTER) || (xController.atGoal() && yController.atGoal() && holonomicDriveController.getThetaController().atGoal());
  }
