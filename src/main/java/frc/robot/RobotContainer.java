...
//THIS IS FOR XBOX CONTROLLER FOR OPERATOR!!!!!!!!
package frc.robot;
...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        j.dA.whileFalse(new InstantCommand(() -> climber.stop()));z
        ...
        j.XboxRightStick.whileTrue(new InstantCommand( () -> elevator.elevatorDown()));
        j.XboxLeftStick.whileTrue(new InstantCommand( () -> elevator.elevatorUp()));
        j.XboxRightStick.whileFalse(new InstantCommand(() -> elevator.elevatorStop()));
        j.XboxLeftStick.whileFalse(new InstantCommand(() -> elevator.elevatorStop()));
        ...
        j.XboxY.whileTrue(new AlgaeL3(algae, elevator)).onFalse(new InstantCommand(() -> elevator.elevatorStop()));
        j.XboxX.whileTrue(new AlgaeL2(algae, elevator)).onFalse(new InstantCommand(() -> elevator.elevatorStop()));
        ...
        j.XboxRB.whileTrue(new InstantCommand(() -> intake.lowerIntake()));
        j.XboxRB.whileTrue(new InstantCommand(() -> intake.intake()));
        j.XboxRB.whileFalse(new InstantCommand(() -> intake.intakeIdle()));
        //j.XboxRB.whileFalse(new InstantCommand(() -> intake.stopIntake()));
        j.XboxRB.whileFalse(new InstantCommand(() -> intake.raiseIntake()));
        ...
        j.XboxLB.whileTrue(new InstantCommand(() -> intake.scoreIntake()));
        j.XboxLB.whileTrue(new InstantCommand(() -> intake.outtake()));
        j.XboxLB.whileFalse(new InstantCommand(() -> intake.stopIntake()));
        j.XboxLB.whileFalse(new InstantCommand(() -> intake.raiseIntake()));
